...
public class ExpressaoXor extends ExpressaoBinaria {
	...
	public boolean eval(Map<String, Boolean> valoresVariaveis) {
		(return super.getLHS().eval(valoresVariaveis) && !super.getRHS().eval(valoresVariaveis)) || (return !super.getLHS().eval(valoresVariaveis) && super.getRHS().eval(valoresVariaveis));
	}
}